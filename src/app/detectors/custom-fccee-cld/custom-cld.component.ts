...
@Component({
  selector: 'app-custom-cld',
  templateUrl: './custom-cld.component.html',
  styleUrls: ['./custom-cld.component.scss'],
  standalone: false,
})
export class CustomCldComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.eventDisplay.loadGLTFGeometry(
      'assets/detectors/custom_CLD.gltf',
      'CLD',
      undefined,
      1,
      true,
