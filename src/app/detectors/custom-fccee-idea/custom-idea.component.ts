...
@Component({
  selector: 'app-custom-idea',
  templateUrl: './custom-idea.component.html',
  styleUrls: ['./custom-idea.component.scss'],
  standalone: false,
})
export class CustomIdeaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.eventDisplay.loadGLTFGeometry(
      'assets/detectors/custom_IDEA.gltf',
      'IDEA',
      undefined,
      1,
      true,
