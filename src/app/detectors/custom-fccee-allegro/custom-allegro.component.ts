...
@Component({
  selector: 'app-custom-allegro',
  templateUrl: './custom-allegro.component.html',
  styleUrls: ['./custom-allegro.component.scss'],
  standalone: false,
})
export class CustomAllegroComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.eventDisplay.loadGLTFGeometry(
      'assets/detectors/custom_ALLEGRO.gltf',
      'ALLEGRO',
      undefined,
      1,
      true,
